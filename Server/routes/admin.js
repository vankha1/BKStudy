...
router.get('/stat-user', isAuth.authToken, isAuth.authRoles('ADMIN'), adminController.getStatUser);

router.get('/stat-course', isAuth.authToken, isAuth.authRoles('ADMIN'), adminController.getStatCourse);
