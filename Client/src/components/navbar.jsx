...
const Navbar = () => {
  ...
  return (
    <div className="navbar mb-5 flex justify-around items-center content-center border border-b-[#cacaca] h-[55px]">
      ...
      <div className="user-choice flex mt-[30px] hidden">
        ...
        <div className="user relative top-[-10px] right-[-10px]">
          ...
          <div className="absolute right-0 top-[50px] w-[130px] border border-[#cacaca] rounded-[10px] bg-white z-20 overflow-hidden hidden">
            <a
              href="/"
              className="block items-center py-[5px] px-[10px] hover:bg-[#cacaca]"
            >
              Trang cá nhân
            </a>
            <a
            ...
            <a
              href="/"
              className="block items-center py-[5px] px-[10px] border border-t-[#cacaca] text-gray-500 hover:bg-[#cacaca]"
            >
              Đăng xuất
            </a>
          </div>
