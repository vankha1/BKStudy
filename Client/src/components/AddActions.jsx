                                ...
                                <div className=''>
                                    <div className='flex-between'>
                                        ...
                                        <Image
                                            ...
                                            className={isSettingFile ? 'relative hover:cursor-pointer transform rotate-[60deg] duration-100' : 'relative hover:cursor-pointer transform rotate-[0deg] duration-100'}
