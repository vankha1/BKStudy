...
const CoursePage = ({ params }) => {
  ...
  const handleRegister = () => {
    ...
    if (token && data.userType == 'STUDENT') {
      let flag = false;
    ...
    else if (token && data.userType != 'STUDENT') {
      warningNotifi('Không để đăng ki khóa học vì là giáo viên!.');
      setTimeout(() => {
        router.push('/');
      }, 1000)
    }
        ...
        <div className="description w-3/5">
          ...
          <div className="flex mb-1">
            <span className="mr-28">
              ...
              {(ratingCourse === 0) ? (<p className="text-orange-500">Chưa có đánh giá</p>) : (<StarRating rating={ratingCourse.avgRating ? ratingCourse.avgRating : 0} />)}
            </span>
          </div>
          <div className="mb-1">
