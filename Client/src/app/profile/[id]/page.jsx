      ...
      {loading ? (
        ...
        <div className="w-full">
          <div className="relative w-full h-80 mt-4">
            <div className="h-72 mt-[55px] rounded-3xl bg-blue-300"></div>
            <div className="absolute bottom-0 left-40 flex justify-between items-center w-[80%]">
              <div className="flex items-center gap-2">
                <div
                  className="w-40 h-40 relative rounded-full flex-center bg-white cursor-pointer"
                ...
                >
                  <Image
                    ...
                    src={
                      userProfile.avatar
                        ? userProfile.avatar.includes("https")
                          ? userProfile.avatar
                ...
                <h2 className="pl-8 text-3xl font-medium">
              ...
              <div
                ...
                className="flex items-center gap-1 cursor-pointer px-2 rounded-[10px] hover:bg-blue-500"
              >
                <Image
                  ...
                  alt="message icon"
                />
                <span className="text-2xl font-bold">Tin nhắn</span>
              </div>
            </div>
          </div>
